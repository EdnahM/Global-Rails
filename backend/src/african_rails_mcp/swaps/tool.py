...
async def quote_swap(
    ...
    no price impact). Falls back to Uniswap V3 for other pairs.

    Args:
        token_in: Input token symbol e.g. "cUSD", "USDC", "CELO"
        token_out: Output token symbol e.g. "cKES", "cUSD", "ETH"
...
async def execute_swap(
    ...
    Uses Uniswap V3 for all other pairs.
